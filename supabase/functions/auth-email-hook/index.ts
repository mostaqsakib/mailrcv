...
// Configuration
const SITE_NAME = "mailrcv"
const SENDER_DOMAIN = "notify.mailrcv.site"
const ROOT_DOMAIN = "mailrcv.site"
const FROM_DOMAIN = "mailrcv.site" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://mailrcv.lovable.app"
    ...
    result = await sendLovableEmail(
      {
        ...
        from: `Mail RCV <no-reply@${FROM_DOMAIN}>`,
